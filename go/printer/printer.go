...
func (p *printer) internalError(msg ...interface{}) {
	if debug {
		...
		fmt.Println(msg...)
		panic("github.com/ggaaooppeenngg/gogo/go/printer")
	}
}
...
func (p *printer) print(args ...interface{}) {
	for _, arg := range args {
		...
		default:
			...
			panic("github.com/ggaaooppeenngg/gogo/go/printer type")
		}
		// data != ""
...
unsupported:
	return fmt.Errorf("github.com/ggaaooppeenngg/gogo/go/printer: unsupported node type %T", node)
}
