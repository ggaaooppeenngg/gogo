...
type (
	...
	GoGoStmt struct {
		GoGo token.Pos // position of "gogo" keyword
		Call *CallExpr
	}
...
func (s *GoGoStmt) Pos() token.Pos       { return s.GoGo }
...
func (s *GoGoStmt) End() token.Pos   { return s.Call.End() }
