...
import (
	"flag"
	"github.com/ggaaooppeenngg/gogo/go/build"
...
func TestIssue20855(t *testing.T) {
	...
	pkg, err := importer.ImportFrom("github.com/ggaaooppeenngg/gogo/go/internal/srcimporter/testdata/issue20855", ".", 0)
...
func TestIssue24392(t *testing.T) {
	testImportPath(t, "github.com/ggaaooppeenngg/gogo/go/internal/srcimporter/testdata/issue24392")
}
